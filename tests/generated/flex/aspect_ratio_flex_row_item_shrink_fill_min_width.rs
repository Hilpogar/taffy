...
fn aspect_ratio_flex_row_item_shrink_fill_min_width__border_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node0 = taffy
        .new_leaf(taffy::style::Style {
            size: taffy::geometry::Size { width: auto(), height: taffy::style::Dimension::from_length(75f32) },
    ...
    assert_eq!(size.width, 175f32, "width of node {:?}. Expected {}. Actual {}", node, 175f32, size.width);
...
#[test]
#[allow(non_snake_case)]
fn aspect_ratio_flex_row_item_shrink_fill_min_width__content_box() {
    #[allow(unused_imports)]
    use taffy::{prelude::*, Layout};
    let mut taffy = crate::new_test_tree();
    let node0 = taffy
